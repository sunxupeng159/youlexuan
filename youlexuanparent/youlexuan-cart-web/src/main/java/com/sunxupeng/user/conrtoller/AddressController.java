...
public class AddressController {
    ...
    public List<TbAddress> findListByLoginUser(){
        ...
        return userService.findListByUserId(userId);
    }
    /**
     * 返回全部列表
     * @return
    ...
    *//**
    ...
    public PageResult search(@RequestBody TbAddress address, int page, int size){
